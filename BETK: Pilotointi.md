...
Pilotoinnissa käytettävien tiedonkantajien tiedot. Pyrimme ensisijaisesti hyödyntämään RFID-teknologiaa tiedonkanta-jina. Vaihtoehtoisena tiedonkantajana voidaan hyödyntää 2D-viivakoodeja (DataMatrix ja GS1 Digital Link).
<table border="1" cellpadding="8" cellspacing="0" style="width:100%; border-collapse:collapse;">
  <thead>
    <tr>
